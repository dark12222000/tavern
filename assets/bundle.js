	  ...
	  function Tavern() {
	    ...
	    this.formatMenuAsTbody = function () {
	      ...
	      this.menu.forEach(function (item) {
	        output += '<tr><td>' + item.name + '</td><td>(' + item.quality + ')</td><td>' + _this.priceFormatter(item.price) + '</td></tr>';
	      });
	      return output;
	    };
	  }
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  menuItems: [{ name: 'Ale', weight: 8.0 }, { name: 'Lager', weight: 6.0 }, { name: 'Stout', weight: 2.0 }, { name: 'Mead', weight: 6.0 }, { name: 'Cherry Mead', weight: 1.0 }, { name: 'Cider', weight: 3.0 }, { name: 'Rum', weight: 1.0 }, { name: 'Wine', weight: 4.0 }, { name: 'Hooch', weight: 1.5 }]
	};
